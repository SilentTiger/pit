...
export enum EventName {
  ...
  DOCUMENT_AFTER_LAYOUT = 'DOCUMENT_AFTER_LAYOUT',
  DOCUMENT_AFTER_DRAW = 'DOCUMENT_AFTER_DRAW',
  DOCUMENT_AFTER_IDLE_LAYOUT = 'DOCUMENT_AFTER_IDLE_LAYOUT',
  DOCUMENT_LAYOUT_FINISH = 'DOCUMENT_LAYOUT_FINISH',
