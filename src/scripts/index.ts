...
const r2 = new Delta()
const r3 = new Delta()
const c1 = new Delta().insert('cell 1').insert(1, { frag: 'end', block: 'para' }).insert('cell 1 line 2').insert(1, { frag: 'end', block: 'para' })
...
r1.insert(c1, { colSpan: 2, rowSpan: 3 })
r1.insert(c2, { rowSpan: 2 })
r3.insert(c4)
tableDelta.insert(r1).insert(r2).insert(r3)
doc.insert(tableDelta, { block: 'table', colWidth: [200, 300, 96] })
