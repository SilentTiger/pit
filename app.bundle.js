...
const measureTextMetrics = (() => {
    ...
    return (attrs) => {
        ...
        if (cacheValue !== undefined) {
            return Object.assign({}, cacheValue);
        }
...
const calListTypeFromChangeData = (changeData) => {
    switch (changeData) {
        case "decimal":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_1;
            break;
        case "ckj-decimal":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_2;
            break;
        case "upper-decimal":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_3;
            break;
        case "circle":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_1;
            break;
        case "ring":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_2;
            break;
        case "arrow":
            return _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_3;
            break;
        default:
...
const calListItemTitle = (type, indent, index, parentTitle) => {
    switch (type) {
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_1:
            return calOl1title(indent, index);
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_2:
            return calOl2title(indent, index);
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ol_3:
            return calOl3title(index, parentTitle);
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_1:
            return calUl1title(indent);
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_2:
            return '⦿';
        case _DocStructure_EnumListStyle__WEBPACK_IMPORTED_MODULE_0__["EnumListType"].ul_3:
...
class Block extends _Common_LinkedList__WEBPACK_IMPORTED_MODULE_0__["LinkedList"] {
     ...
     * @param pos 位置信息对象
     */
    setPositionY(y, recursive = true, force = false) {
    ...
    delete(index, length) {
        ...
        for (let frameIndex = 0; frameIndex < frames.length; frameIndex++) {
            ...
            if (index <= element.start && index + length >= element.start + element.length) {
                ...
                element.delete(offsetStart, Math.min(element.start + element.length, index + length) - element.start - offsetStart);
            }
        }
        // 尝试内部 merge frame
        if (frameMerge) {
...
/* harmony import */ var _FragmentDate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./FragmentDate */ "./src/scripts/DocStructure/FragmentDate.ts");
/* harmony import */ var _FragmentImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FragmentImage */ "./src/scripts/DocStructure/FragmentImage.ts");
/* harmony import */ var _FragmentParaEnd__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./FragmentParaEnd */ "./src/scripts/DocStructure/FragmentParaEnd.ts");
/* harmony import */ var _FragmentText__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./FragmentText */ "./src/scripts/DocStructure/FragmentText.ts");
/* harmony import */ var _LayoutFrame__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./LayoutFrame */ "./src/scripts/DocStructure/LayoutFrame.ts");
/* harmony import */ var _ListItem__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ListItem */ "./src/scripts/DocStructure/ListItem.ts");
/* harmony import */ var _Paragraph__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Paragraph */ "./src/scripts/DocStructure/Paragraph.ts");
/* harmony import */ var _QuoteBlock__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./QuoteBlock */ "./src/scripts/DocStructure/QuoteBlock.ts");
...
class Document extends _Common_LinkedList__WEBPACK_IMPORTED_MODULE_3__["LinkedList"] {
    constructor() {
        ...
        this.applyChanges = (delta, pushHistory = true) => {
            let opOffset = 0;
            delta.forEach((op) => {
    ...
    delete(forward = true) {
        ...
        if (length === 0 && forward) {
            ...
            if (index - targetBlock.start === 0 && !(targetBlock instanceof _Paragraph__WEBPACK_IMPORTED_MODULE_13__["default"])) {
                let frames;
                let posBlock;
                if (targetBlock instanceof _ListItem__WEBPACK_IMPORTED_MODULE_12__["default"]) {
                ...
                const paragraphs = frames.map((frame) => {
                    return new _Paragraph__WEBPACK_IMPORTED_MODULE_13__["default"](frame, _IEditorConfig__WEBPACK_IMPORTED_MODULE_6__["default"].canvasWidth);
                });
                if (posBlock !== null) {
        ...
        for (let blockIndex = 0; blockIndex < blocks.length; blockIndex++) {
            ...
            if (index <= element.start && index + length >= element.start + element.length) {
                this.remove(element);
                if (element instanceof _ListItem__WEBPACK_IMPORTED_MODULE_12__["default"]) {
        ...
        if (blockMerge && blocks[0].nextSibling !== null) {
            ...
            if (needRemove) {
                if (blocks[0].nextSibling instanceof _ListItem__WEBPACK_IMPORTED_MODULE_12__["default"]) {
    ...
    getFragmentFromOp(op) {
        ...
        if (typeof data === 'string') {
            if (data !== '\n') {
                // 如果不是换行符说明是普通内容
                return new _FragmentText__WEBPACK_IMPORTED_MODULE_10__["default"](op, attributes, data);
            }
            else {
                return new _FragmentParaEnd__WEBPACK_IMPORTED_MODULE_9__["default"](op);
            }
        }
        else if (typeof data === 'object') {
            if (data['gallery-block'] !== undefined || data.gallery !== undefined) {
                // 如果 gallery-block 存在说明是图片
                return new _FragmentImage__WEBPACK_IMPORTED_MODULE_8__["default"](op, attributes, data.gallery || data['gallery-block']);
            }
            else if (data['date-mention'] !== undefined) {
                // 如果 date-mention 存在说明是日期
                return new _FragmentDate__WEBPACK_IMPORTED_MODULE_7__["default"](op, attributes, data['date-mention']);
            }
...
/* harmony import */ var quill_delta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! quill-delta */ "./node_modules/quill-delta/dist/Delta.js");
/* harmony import */ var quill_delta__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(quill_delta__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _assets_linebreaker_linebreaker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../assets/linebreaker/linebreaker */ "./src/assets/linebreaker/linebreaker.js");
/* harmony import */ var _Common_EnumEventName__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Common/EnumEventName */ "./src/scripts/Common/EnumEventName.ts");
/* harmony import */ var _Common_LayoutPiece__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Common/LayoutPiece */ "./src/scripts/Common/LayoutPiece.ts");
/* harmony import */ var _Common_LinkedList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Common/LinkedList */ "./src/scripts/Common/LinkedList.ts");
/* harmony import */ var _Common_Platform__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Common/Platform */ "./src/scripts/Common/Platform.ts");
/* harmony import */ var _Common_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Common/util */ "./src/scripts/Common/util.ts");
/* harmony import */ var _RenderStructure_Line__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../RenderStructure/Line */ "./src/scripts/RenderStructure/Line.ts");
...
class LayoutFrame extends _Common_LinkedList__WEBPACK_IMPORTED_MODULE_5__["LinkedList"] {
        ...
        this.calLineBreakPoint = () => {
            ...
            for (let i = 0, l = this.children.length; i < l; i++) {
                ...
                if (currentFrag instanceof _FragmentText__WEBPACK_IMPORTED_MODULE_12__["default"]) {
                    ...
                    const piece = new _Common_LayoutPiece__WEBPACK_IMPORTED_MODULE_4__["default"](true);
    ...
    layout() {
        ...
        if (tailLine !== null && tailLine.children.length === 0) {
            tailLine.add(new _RenderStructure_RunText__WEBPACK_IMPORTED_MODULE_10__["default"](this.children[0], 0, 0, ''));
        }
        this.setIndex();
        for (let i = 0, l = this.lines.length; i < l; i++) {
            let align;
            if (this.attributes.align === _EnumParagraphStyle__WEBPACK_IMPORTED_MODULE_11__["EnumAlign"].justify && i === l - 1) {
                align = _EnumParagraphStyle__WEBPACK_IMPORTED_MODULE_11__["EnumAlign"].left;
            }
            else if (this.attributes.align === _EnumParagraphStyle__WEBPACK_IMPORTED_MODULE_11__["EnumAlign"].scattered) {
                align = _EnumParagraphStyle__WEBPACK_IMPORTED_MODULE_11__["EnumAlign"].justify;
            }
            else {
    ...
    constructLayoutPieces(frags) {
        ...
        // 然后开始计算断行点
        const breaker = new _assets_linebreaker_linebreaker__WEBPACK_IMPORTED_MODULE_2__["default"](totalString);
            ...
            if (currentPiece.totalWidth <= freeSpace) {
                if (currentPiece.isHolder) {
                    ...
                    if (currentPiece.frags.length === 1) {
                        const run = new _RenderStructure_RunText__WEBPACK_IMPORTED_MODULE_10__["default"](currentPiece.frags[0].frag, 0, 0, currentPiece.text);
                        ...
                        for (let index = 0, fl = currentPiece.frags.length; index < fl; index++) {
                            ...
                            const run = new _RenderStructure_RunText__WEBPACK_IMPORTED_MODULE_10__["default"](frag.frag, 0, 0, currentPiece.text.substring(frag.start, frag.end));
                ...
                while (fragIndex < currentPiece.frags.length) {
                    ...
                    if (currentPiece.fragWidth[fragIndex] <= lineFreeSpace) {
                        ...
                        const run = new _RenderStructure_RunText__WEBPACK_IMPORTED_MODULE_10__["default"](currentFrag.frag, 0, 0, currentPiece.text.substring(currentFrag.start, currentFrag.end));
                        ...
                        while (charStartIndex <= currentFrag.end) {
                            for (let length = currentFrag.end - charStartIndex + 1; length >= 0; length--) {
                                ...
                                if (charPieceWidth <= lineFreeSpace) {
                                    // 如果空间足够就插入
                                    const run = new _RenderStructure_RunText__WEBPACK_IMPORTED_MODULE_10__["default"](currentFrag.frag, 0, 0, text);
     ...
     * @param length range 的长度
     */
    findFragmentsByRange(index, length) {
        let res = [];
        let current = 0;
        let end = this.children.length;
        let step = 1;
...
/* harmony import */ var _IEditorConfig__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IEditorConfig */ "./src/scripts/IEditorConfig.ts");
/* harmony import */ var _Loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Loader */ "./src/scripts/Loader.ts");
...
(() => {
    ...
    const fileSelect = document.querySelector('#selFileName');
...
const editor = new _Editor__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector('#divEditor'), _IEditorConfig__WEBPACK_IMPORTED_MODULE_2__["default"]);
(() => {
    const w = window;
    w.hit = 0;
    w.cal = 0;
